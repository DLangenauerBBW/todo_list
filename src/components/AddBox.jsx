...
export default function AddBox({ closeWindow, submitAddTask }) {
  //Setzt den State für das Formular und setzt ein paar Standartwerte
  ...
  //Submithandler verarbeitet die Daten schlussendlich
    ...
    <div onClick={closeWindow} className="addtaskOverlay">
      <div className="addtaskContent" onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="saveButton">Save Task</button>
        </form>
      </div>
    </div>
  );
